...
export const metadata: Metadata = {
  ...
  description:
    "Launch a city-specific job board with hyper-local features, community focus, and local business integration. Connect local talent with opportunities in your city.",
};
